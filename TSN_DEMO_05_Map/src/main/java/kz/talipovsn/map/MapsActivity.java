...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    static final LatLng marker1 = new LatLng(52.273312,76.967841); // Маркер Белый Ветер
    static final LatLng marker2 = new LatLng(52.274035,76.966727); // Маркер Wildberries
    static final LatLng marker3 = new LatLng(52.2693893,76.9704737); // Маркер БИЛ
    static final LatLng marker4 = new LatLng(52.2756535,76.9697155); // Маркер Евразийского Банка
    static final LatLng marker5 = new LatLng(52.273655,76.972733); // Маркер Учебный Куис
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addMarker(new MarkerOptions().position(marker3).title((getString(R.string.marker3_title))).icon(
                        BitmapDescriptorFactory.fromResource(R.drawable.bil)).alpha(ALPHA).
